    ...
    for idx, desired_scene in enumerate(dataset.scenes()):
        ...
        for t in trange(1, sim_scene.scene.length_timesteps):
            ...
            for idx, agent_name in enumerate(obs.agent_name):
                ...
                print(obs.agent_fut[idx, 0],next_state)
        ...
        plot_agent_batch(obs, 0, show=True, close=False)
        plot_agent_batch(obs, 1, show=True, close=False)
        plot_agent_batch(obs, 2, show=True, close=False)
